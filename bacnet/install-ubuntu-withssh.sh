...
cp $BASEDIR/../modbus/withssl/paho_Makefile_cs paho.mqtt.c/Makefile
cd paho.mqtt.c 
sudo make install

# 9, make the install libs take effect
echo "9. run ldconfig"
sudo ldconfig

# 10, make Baidu Iot Edge SDK
echo "10. make Baidu Iot Edge SDK"
cd $BASEDIR
make all WITHSSL=yes
